...
//            if !usernameExists {
//                let today = Date()
//                let stringDate = today.toString(dateFormat: "yyyy-MM-dd HH:mm:ss")
//                
//                if let newTextMessage = Message(messageType: .text, isSender: false, time: stringDate , nameSender: nickname , filePath: "", messageText: text) {
...
//                    
//                    if   let newAudioMessage = Message(messageType: .audio, isSender: false, time: "", nameSender: self.userName, filePath: imageBase64String, messageText: "") {
...
//
//                if let newImageMesssage = Message(messageType: .photo, isSender: false, time: "", nameSender: self.userName, filePath: "", messageText: "") {
...
//                if let newGifMessage = Message(messageType: .gif, isSender: false, time: "", nameSender: gif.element![1] as! String, filePath: path as! String, messageText: "") {
...
//            
//            
////            if let newFileMessage = Message(messageType: .file, isSender: true, time: Date(), nameSender: "Tobias", filePath: file.displayName, messageText: "") {
...
//        if let _url = url {
////            if let newGifMessage = Message(messageType: .gif, isSender: true, time: Date(), nameSender: self.userName, filePath: _url, messageText: "") {
////                self.addNewMessageToCollectionView(newMessage: newGifMessage)
////            }
//            
...
//        if let _url = url {
////            if let newAudioMessage = Message(messageType: .audio, isSender: true, time: Date(), nameSender: self.userName, filePath: _url, messageText: "") {
////                self.addNewMessageToCollectionView(newMessage: newAudioMessage)
////            }
//            
...
//        
////        if let newTextMessage = Message(messageType: .text, isSender: true, time: Date(), nameSender: "Tobias", filePath: "", messageText: messageText) {
////            self.addNewMessageToCollectionView(newMessage: newTextMessage)
////        }
